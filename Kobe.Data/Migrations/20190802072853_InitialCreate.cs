        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Population = table.Column<string>(type: "varchar(150)", nullable: false),
                    Area = table.Column<string>(type: "varchar(150)", nullable: false),
                    ISO3166 = table.Column<string>(nullable: true),
                    DrivingSide = table.Column<string>(type: "varchar(150)", nullable: false),
                    Capital = table.Column<string>(type: "varchar(150)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryRohit", x => x.Id);
                });
